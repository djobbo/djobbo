...
export const Logo = ({ size }: IconBaseProps) => (
    ...
    >
        <path
            ...
            transform="translate(-593.212 -528.75)"
        />
        <path
            d="M974.168,1024c5.957,26.239-6.3,36.86-16.607,45.957H936.912A157.681,157.681,0,0,0,974.168,1024Z"
            transform="translate(-899.898 -970.665)"
        />
    </svg>
)
